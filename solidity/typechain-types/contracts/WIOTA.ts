...
export interface WIOTAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WIOTA extends BaseContract {
  connect(runner?: ContractRunner | null): WIOTA;
  waitForDeployment(): Promise<this>;

  interface: WIOTAInterface;
